...
var HTTPRequestContext = /** @class */ (function (_super) {
    ...
    HTTPRequestContext.create = function (server, request, response, _rootPath, _callback) {
        ...
        ctx.askForAuthentication(false, request.domainName, function (e) {
            if (e) {
                callback(e, ctx);
                return;
            }
    ...
    HTTPRequestContext.prototype.askForAuthentication = function (checkForUser, domain, callback) {
        if (checkForUser && this.user !== null && !this.user.isDefaultUser) {
            callback(Errors_1.Errors.AlreadyAuthenticated);
            return;
        }
        var auth = this.server.httpAuthentication.askForAuthentication(domain);
